...
const CACHE_NAME = 'begumnaz-v51-iter64-equip-mode-analytics-cta-worker-v2024-10-22-2026-05-13';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
...
self.addEventListener('push', (event) => {
  ...
  try {
    ...
    data = { title: 'Begümnaz Program', body: event.data ? event.data.text() : '' };
  }
  const title = data.title || 'Begümnaz Program';
  const options = {
    body: data.body || '',
